...
from BERTriage.model_config import max_length_of_phrase,batch_size,num_of_classes,train_split,epochs,use_multiprocessing
import os


def train_model(dataset_csv_path,model_checkpoint_path):
    ...
    print("Validation size each epochs: " + str(len(validation_set)))

    # Define model parameters
    sentiment_model = create_model()

    # Model Training
    checkpoint_filepath = os.path.join(model_checkpoint_path,'epoch{epoch:02d}-acc{val_accuracy:.2f}.hdf5')
